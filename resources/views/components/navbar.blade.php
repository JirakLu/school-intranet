<div x-data="{showMobileMenu: false}" class="relative bg-white border-b-2 border-gray-100">
    ...
    <div
            ...
            x-show="showMobileMenu" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                ...
                <div class="mt-6">
                    <nav class="grid gap-y-8">
                        ...
                        <a href="#" class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                            ...
                            <span class="ml-3 text-base font-medium text-gray-900"> Naše prestiž </span>
                        </a>
                    </nav>
                </div>
            </div>
